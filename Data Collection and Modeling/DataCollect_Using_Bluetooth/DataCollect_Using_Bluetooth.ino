...
void setup() {
    ...
    // Isaac's Offsets
    /* 
    mpu.setXAccelOffset(-1058.005985);
    mpu.setYAccelOffset(475.5881995);
    mpu.setZAccelOffset(1839.886979);
    mpu.setXGyroOffset(73.99894661);
    mpu.setYGyroOffset(-11.93861639);
    mpu.setZGyroOffset(14.86692684);
    */
